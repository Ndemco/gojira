 ...
 *  If [issue-level security](https://confluence.atlassian.com/x/J4lKLg) is configured, issue-level security perm

## Parameters
- `issueIdOrKey` [path] (required) string — The ID or key of the issue.
- `linkId` [path] (required) string — The ID of a remote issue link.
