...
**[Permissions](#permissions) required:** *Administ

## Parameters
- `id` [path] (required) string — The ID of the version to delete.
- `moveIssuesTo` [path] (required) string — The ID of the version to merge into.
