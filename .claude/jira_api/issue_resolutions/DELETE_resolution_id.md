...
## Parameters
- `id` [path] (required) string — The ID of the issue resolution.
- `replaceWith` [query] (required) string — The ID of the issue resolution that will replace the currently selected resolution.
