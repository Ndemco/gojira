...
- `updateDraftIfNeeded` [query] boolean — Set to true to create or update the draft of a workflow scheme and update the mapping in the draft, when the workflow sc
