...
- `issueTypeScreenSchemeId` [query] []integer(int64) — The list of issue type screen scheme IDs. To include multiple issue type screen schemes, separate IDs with ampersand: `i
