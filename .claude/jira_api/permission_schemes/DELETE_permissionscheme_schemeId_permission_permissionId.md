...
## Parameters
- `schemeId` [path] (required) integer(int64) — The ID of the permission scheme to delete the permission grant from.
- `permissionId` [path] (required) integer(int64) — The ID of the permission grant to delete.
