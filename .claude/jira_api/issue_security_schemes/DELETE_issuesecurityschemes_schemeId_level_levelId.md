...
- `levelId` [path] (required) string — The ID of the issue security level to remove.
- `replaceWith` [query] string — The ID of the issue security level that will replace the currently selected level.
