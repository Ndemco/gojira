...
## Parameters
- `schemeId` [path] (required) integer(int64) — The ID of the priority scheme.

## Request Body
Content-Type: `application/json`
object:
  - `defaultPriorityId`: integer(int64)
  - `description`: string
  - `mappings`: allOf(PriorityMapping)
  - `name`: string
  - `priorities`: allOf(UpdatePrioritiesInSchemeRequestBean)
  - `projects`: allOf(UpdateProjectsInSchemeRequestBean)
